...
local function replace(uri, text, diffs, this_mod)
  ...
  global_name_builder[4] = scenario and scenario or nil
  global_name_builder[5] = scenario and "__" or nil

  -- build string and replace any special characters with _
  local global_name = table.concat(global_name_builder, "")
  global_name = global_name:gsub("[^a-zA-Z0-9_]","_")
